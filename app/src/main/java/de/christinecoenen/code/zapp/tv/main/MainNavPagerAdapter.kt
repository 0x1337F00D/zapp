...
import de.christinecoenen.code.zapp.tv.mediathek.MediathekComposeFragment
...
class MainNavPagerAdapter(
	...
	private val navItems = listOf(
		...
		MainNavItem(R.string.activity_main_tab_mediathek, MediathekComposeFragment::class),
